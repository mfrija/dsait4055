...
MODEL_CONFIGS = {
    ...
    "3_300d": {
        ...
        "output_dir": Path("reports/3_user_clustering_300d"),
    },
    "5_300d": {
        "checkpoint_path": Path("nrms_300d.pt"),
        "training_history_path": Path("checkpoints/nrms_300d/training_history.json"),
        "output_dir": Path("reports/5_user_clustering_300d"),
    },
    "8_300d": {
        "checkpoint_path": Path("nrms_300d.pt"),
        "training_history_path": Path("checkpoints/nrms_300d/training_history.json"),
        "output_dir": Path("reports/8_user_clustering_300d"),
    },
    "10_300d": {
        "checkpoint_path": Path("nrms_300d.pt"),
        "training_history_path": Path("checkpoints/nrms_300d/training_history.json"),
        "output_dir": Path("reports/10_user_clustering_300d"),
    },
}
